...
public class Swagger2Config
{
    ...
    public Docket api()
    {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors
                        .basePackage("com.postit.userdata"))
    ...
    {
        return new ApiInfoBuilder().title("Post-It User Data API")
                .description("The api that hold user login information and saved items")
                .contact(new Contact("Adrian Hartley",
                        "http://www.lambdaschool.com",
                        "hannah-hartley@lambdastudents.com"))
                .license("MIT")
                .licenseUrl("https://github.com/Build-Post-Here-1/back-end/blob/master/LICENSE")
                .version("1.0.0")
                .build();
    }
}